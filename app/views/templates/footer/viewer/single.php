                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [
                          <?php
                            $january = 1;
                            $dataJanuray = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $january);
                          ...
                          <?php
                            $februari = 2;
                            $dataFebruary = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $februari);
                          ...
                          <?php
                            $maret = 3;
                            $dataMaret = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $maret);
                          ...
                          <?php
                            $april = 4;
                            $dataApril = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $april);
                          ...
                          <?php
                            $mei = 5;
                            $dataMei = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $mei);
                          ...
                          <?php
                            $juni = 6;
                            $dataJuni = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $juni);
                          ...
                          <?php
                            $juli = 7;
                            $dataJuli = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $juli);
                          ...
                          <?php
                            $agustus = 8;
                            $dataAgustus = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $agustus);
                          ...
                          <?php
                            $september = 9;
                            $dataSeptember = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $september);
                          ...
                          <?php
                            $november = 10;
                            $dataNovember = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $november);
                          ...
                          <?php
                            $oktober = 11;
                            $dataOktober = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $oktober);
                          ...
                          <?php
                            $desember = 12;
                            $dataDesember = $this->model('Transaksi_model')->getDataBulananTahunan($_SESSION['keycab']['id'], $desember);
